...
const Accesories = () => {  
  ...
  useEffect(()=>{
    fetch("https://ecommerce-backend-beryl-six.vercel.app/accesoriesData")
    .then(res=>res.json())
    .then(json=>setaccesoriesData(json))
    .catch(err=>console.log("error"))
  },[])
  useEffect(()=>{
    fetch("https://ecommerce-backend-beryl-six.vercel.app/accesoriesMainPic")
    .then(res=>res.json())
  ...
  return (
    <>
    <Header/>
    <div style={{width:"100%",backgroundColor:"rgb(2, 246, 246)"}}>
